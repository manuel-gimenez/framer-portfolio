...
4. Cross-check against existing tokens in
   [`../design-system/README.md`](../design-system/README.md) — don't invent
...
> `docs/design-system/README.md`. Here are reference screenshots: [attach].
...
3. Log changes in section briefs or design-system doc if tokens changed.
...
| [`../design-system/README.md`](../design-system/README.md) | Token source of truth |
